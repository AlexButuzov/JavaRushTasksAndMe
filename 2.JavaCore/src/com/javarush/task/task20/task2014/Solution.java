...
public class Solution implements Serializable {
    public static void main(String[] args) {
        ...
        try {
            ObjectOutputStream fileOutputStream = new ObjectOutputStream(new FileOutputStream(fileAddress));
            fileOutputStream.writeObject(savedObject);
